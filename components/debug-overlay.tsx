...
const DebugOverlay: FC = () => {
  ...
  return (
    <>
      <div className="w-0 xl:w-[250px] absolute inset-y-1/2 -translate-y-1/2 left-3 overflow-auto h-[90%] flex flex-col justify-center items-center">
        <pre className="w-full text-[9px] whitespace-pre-wrap break-all">
          profile: {JSON.stringify(profile, null, 2)}
        </pre>
      </div>
      <div className="w-0 xl:w-[250px] absolute inset-y-1/2 -translate-y-1/2 right-3 overflow-auto h-[90%]">
        <pre className="w-full text-[9px] whitespace-pre-wrap break-all">
